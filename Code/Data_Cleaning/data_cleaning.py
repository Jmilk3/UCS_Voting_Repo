...
with open(Path(__file__ + "/../../../Raw Data/Election Data/All_Elections_7-26-22.csv").resolve(), "r", encoding="utf-8-sig") as file:
    df = read_csv(file)
...
with open(Path(__file__ + "/../../../Raw Data/Election Data/All_Elections_11-7-23.csv").resolve(), "r", encoding="utf-8-sig") as file:
    df = read_csv(file)
...
out_df["Precinct"] = df["Precinct"].map(addLeadingZeros) # Additional cleaning to match precinct codes to reg data
